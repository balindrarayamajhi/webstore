...
public class InMemoryCartRepository implements CartRepository{ 
	...
	@Autowired private NamedParameterJdbcTemplate jdbcTempleate; 
	@Autowired private ProductService productService; 
	
	public void create(CartDto cartDto) { String INSERT_CART_SQL = "INSERT INTO CART(ID) VALUES (:id)";
	...
	cartDto
		.getCartItems()	
		.stream() 
		.forEach(cartItemDto ->{ Product productById = productService.getProductById (cartItemDto.getProductId()); 
		
		String INSERT_CART_ITEM_SQL ="INSERT INTO CART_ITEM(ID,PRODUCT_ID"+

									",CART_ID,QUANTITY) " + "VALUES (:id, :product_id, :cart_id, :quantity)";
	...
	public Cart read(String id){ 
		...
		params.put("id", id); CartMapper cartMapper = new CartMapper(jdbcTempleate, productService); 
	...
	public void update(String id, CartDto cartDto){ 
		...
		for(CartItemDto cartItem :cartItems) { String SQL = "UPDATE CART_ITEM SET QUANTITY = :quantity, PRODUCT_ID = :productId WHERE ID = :id AND CART_ID = :cartId"; 
	...
	public void addItem(String cartId, String productId){ 
		...
		if(cart ==null){ 
			...
			newCartItemDto.setQuantity(1); CartDto 
			
			newCartDto = new CartDto(cartId); 
	...
	public void removeItem(String cartId, String productId){ 
		...
		params.put("id", cartId); params.put("productId", productId); 
